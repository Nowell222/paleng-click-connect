...
import {
  CreditCard, BarChart3, Bell, QrCode, Shield, Users, ArrowRight, CheckCircle2,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-20 md:py-32">
        ...
        <div className="container relative mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center animate-fade-in">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border bg-card px-4 py-1.5 text-sm text-muted-foreground shadow-civic">
            ...
            <div className="mt-10">
              ...
              <div className="inline-flex gap-2 rounded-xl border bg-card p-2 shadow-civic">
                ...
                <Link to="/cashier"><Button variant="outline" size="sm">Cashier</Button></Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-20 md:py-28">
        <div className="container mx-auto px-4">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            <h2 className="text-3xl font-bold text-foreground md:text-4xl">Built for the Pamilihang Bayan</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <div key={feature.title} className="rounded-2xl border bg-card p-6 shadow-civic hover:shadow-lg transition-shadow">
      ...
      <section id="about" className="border-t bg-card py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            <h2 className="text-3xl font-bold text-foreground md:text-4xl mb-6">Why PALENG-CLICK?</h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>The San Juan Public Market sits on 1.92 hectares at the heart of the municipality's commercial district. With 955 stallholders — including 727 awarded stalls, 120 fish retailers, 35 meat retailers, and more — it is the center of daily commerce.</p>
              <p>However, stall payment delinquency rose from <strong className="text-foreground">13.94% in 2023</strong> to <strong className="text-accent">20.01% in 2024</strong>, threatening the LGU's revenue and its capacity to fund essential public services.</p>
              <p>PALENG-CLICK addresses this by offering accessible online payments, staggered installment options, automated SMS reminders, and comprehensive administrative tools — creating a more resilient, prosperous, and vibrant public market.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t py-8">
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row">
          ...
          <p className="text-sm text-muted-foreground">© 2026 Municipality of San Juan, Batangas. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
